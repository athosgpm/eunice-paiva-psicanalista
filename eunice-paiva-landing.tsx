...
import { Heart, Phone, Mail, MapPin, Clock, Star, ArrowRight, MessageCircle, User, Calendar, ChevronDown, Instagram, Facebook, Linkedin, ChevronLeft, ChevronRight } from 'lucide-react';
      ...
      <div className="min-h-screen bg-gradient-to-b from-purple-50 to-white">
        ...
        >
          <div className="max-w-6xl mx-auto">
            ...
            <div className="block md:hidden relative">
              {/* Setas do carrossel - stories */}
              {stories.length > 1 && (
                <>
                  <button
                    aria-label="História anterior"
                    onClick={() => setStoryIndex((storyIndex - 1 + stories.length) % stories.length)}
                    className="absolute left-2 top-1/2 -translate-y-1/2 bg-white/80 rounded-full shadow flex items-center justify-center w-10 h-10 text-purple-600 hover:bg-purple-100 transition z-10 border border-purple-100"
                  >
                  ...
                  <button
                    ...
                    className="absolute right-2 top-1/2 -translate-y-1/2 bg-white/80 rounded-full shadow flex items-center justify-center w-10 h-10 text-purple-600 hover:bg-purple-100 transition z-10 border border-purple-100"
                  >
        ...
        >
          <div className="max-w-6xl mx-auto">
            ...
            {/* Carousel para mobile */}
            <div className="block md:hidden relative">
              {/* Setas do carrossel - testimonials */}
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                  Sou psicanalista com experiência ouvindo histórias e ajudando a curar feridas da alma.
          ...
          <div className="max-w-6xl mx-auto text-center">
            ...
            <div className="flex flex-col md:flex-row justify-center gap-6 mb-8 items-center">
              <div className="flex justify-center gap-6 mb-0">
                <a href="https://www.instagram.com/eunice_paiva_psicanalista" target="_blank" rel="noopener noreferrer" className="hover:text-purple-400 transition-colors transform hover:scale-110"><Instagram size={24} /></a>
              </div>
              <div className="flex items-center gap-2">
                <Phone size={16} />
